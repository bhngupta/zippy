...
import zippy_pb2 as zippy__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in zippy_pb2_grpc.py depends on'
...
def add_ZippyServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'zippy.Zippy', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('zippy.Zippy', rpc_method_handlers)
