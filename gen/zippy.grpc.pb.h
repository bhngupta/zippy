 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status ExecuteCommand(::grpc::ClientContext* context, const ::zippy::CommandRequest& request, ::zippy::CommandResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::zippy::CommandResponse>> AsyncExecuteCommand(::grpc::ClientContext* context, const ::zippy::CommandRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::zippy::CommandResponse>>(AsyncExecuteCommandRaw(context, request, cq));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status ExecuteCommand(::grpc::ClientContext* context, const ::zippy::CommandRequest& request, ::zippy::CommandResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::zippy::CommandResponse>> AsyncExecuteCommand(::grpc::ClientContext* context, const ::zippy::CommandRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::zippy::CommandResponse>>(AsyncExecuteCommandRaw(context, request, cq));
    }
  ...
  class WithAsyncMethod_ExecuteCommand : public BaseClass {
   ...
   public:
    ...
    void RequestExecuteCommand(::grpc::ServerContext* context, ::zippy::CommandRequest* request, ::grpc::ServerAsyncResponseWriter< ::zippy::CommandResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_ExecuteCommand() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::zippy::CommandRequest, ::zippy::CommandResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::zippy::CommandRequest* request, ::zippy::CommandResponse* response) { return this->ExecuteCommand(context, request, response); }));}
    void SetMessageAllocatorFor_ExecuteCommand(
        ::grpc::MessageAllocator< ::zippy::CommandRequest, ::zippy::CommandResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::zippy::CommandRequest, ::zippy::CommandResponse>*>(handler)
    ...
    WithStreamedUnaryMethod_ExecuteCommand() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::zippy::CommandRequest, ::zippy::CommandResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::zippy::CommandRequest, ::zippy::CommandResponse>* streamer) {
